            ...
            <div className="max-w-[1200px] mx-auto px-6 py-12">
                <div className="grid md:grid-cols-3 gap-8 items-center text-center md:text-left">
                    ...
                    <div>
                        <a href="#hero" onClick={e => handleNavClick(e, '#hero')} className="text-2xl font-bold">
                            ...
                            <span className="text-text font-light"> Shaikh</span>
                        </a>
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        {['About', 'Projects', 'Skills', 'Contact'].map(link => (
                            <a
                                ...
                                className="text-sm text-text-light hover:text-primary transition-colors font-medium"
                            >
                                {link}
                            </a>
                        ))}
                    ...
                    <div className="flex justify-center md:justify-end gap-3">
                        <a href="https://linkedin.com/in/abdullah-shaikh225" target="_blank" rel="noopener noreferrer"
                            className="w-10 h-10 rounded-lg bg-background flex items-center justify-center text-text-light hover:text-primary hover:bg-primary/5 transition-all">
                ...
                <div className="border-t border-border/50 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-text-light text-sm">
                        © {currentYear} Abdullah Shaikh. All rights reserved.
                    </p>
                    <p className="text-text-light text-xs">
                        Built with <span className="text-primary">React</span>, <span className="text-secondary">Supabase</span> & ❤️
                    </p>
                </div>
            </div>
        </footer>
